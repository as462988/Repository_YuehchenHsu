...
/*10.
  透過變數中所提供值的來自動推論型態
  >輸入小數點會判斷為 double Ex: var pi = 3.2147
  >輸入數值會判斷為 int Ex: var weight = 20
  >輸入"文字"會判斷為 String Ex: let name = "Yueh" or let number = " 0912344776"
*/

/*11.var phoneNumber = 0987654321
     phoneNumber = "Hello, world."
  Answer :phoneNumber 被推論型態為 int,不可使用 String 改變他的值
 */
